  ...
  return (
    <>
      ...
      <Card style={{ width: "inherit" }}>
        ...
        <Card.Body>
          <Card.Title>Bulk Carries</Card.Title>
          <Card.Text className="icon-text"> <i class="fas fa-sm fa-tag"></i> $10000 <del> $10100</del></Card.Text>
        ...
        <Card.Footer className="mb-2">
          <Card.Link href="/"><small><i class="fas fa-sm fa-map-marker"></i> Surabaya</small></Card.Link>
        </Card.Footer>
      </Card>
      {/* End Card Product */}
