  ...
  return (
    <>
      ...
      <Card style={{ width: "inherit" }}>
        ...
        <Card.Body>
          <Card.Title>Gas Carriers</Card.Title>
          <Card.Text className="icon-text"> <i class="fas fa-sm fa-tag"></i>  $9100 <del> $9900</del></Card.Text>
        ...
        <Card.Footer className="mb-2">
          <Card.Link href="/"><small className="text-muted"><i class="fas fa-sm fa-tag"></i> 15%</small></Card.Link>
        </Card.Footer>
      </Card>
      {/* End Card Product */}
