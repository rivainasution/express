  ...
  return (
    <>
      ...
      <Card style={{ width: "inherit" }}>
        ...
        <Card.Body>
          <Card.Title>Container Ships</Card.Title>
          <Card.Text className="icon-text"> <i class="fas fa-sm fa-tag"></i> $10000 <del> $10200</del></Card.Text>
        ...
        <Card.Footer className="mb-2">
          <Card.Link href="/"><small><i class="fas fa-sm fa-clock"></i> 17 August 2020</small></Card.Link>
        </Card.Footer>
      </Card>
      {/* End Card Product */}
